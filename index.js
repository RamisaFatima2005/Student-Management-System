...
let secondQuestion = await inquirer.prompt([
    {
        ...
        choices: ["CIT", "Web and Graphic Designing", "Web Development", "Digital Marketing", "Freelancing", "PowerBI", "Business Development", "Daraz", "Amazon"]
    }
]);
let balance = 20000;
let one = 100;
    ...
    let fourthQuestion = await inquirer.prompt([
        {
            ...
            choices: ["CIT '100$'", "Web and Graphic Designing '500$'", "Web Development '1000$'", "Digital Marketing '1000$'", "Freelancing '500$'", "PowerBI '2000$'", "Business Development'100$'", "Daraz '500$'", "Amazon '2000$"]
        }
    ]);
